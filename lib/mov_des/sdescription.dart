...
class SDescription extends StatefulWidget {
  const SDescription({super.key});

  @override
  State<SDescription> createState() => _SDescriptionState();
}

class _SDescriptionState extends State<SDescription> {
  @override
              ...
              Padding(
                ...
                child: Stack(
                    ...
                    children: [
                      ...
                      IconButton(onPressed: () {}, icon: const Icon(Icons.play_circle,color: Colors.white60,size: 100,))
                    ]
                ),
              ),
              const SizedBox(height: 10,),
              const Text('Stranger Things',style: TextStyle(
                  color: Colors.white,
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Center(
                      child: Text('Mystery',style: TextStyle(
                          color: Colors.white54
                      ),),
                    ),
                  ),
